...
export default {
  ...
  methods: {
    ...
    selectChange(selectValue){
        ...
        fetch('https://localhost:5000/items?status='+selectValue, 
        {
          method: 'GET',
        })
        .then((res) => res.json())
    ...
    delitem(id){
       fetch('https://localhost:5000/deleteitem/'+id, 
            {
                method: 'DELETE',
            })
    ...
    updateStatus(updataData){
        fetch('https://localhost:5000/updatestatus/'+updataData.id, 
        {
            method: 'PUT',
        })
        .then((res) => res.json())
    ...
    addItem(itemData){
      ...
      fetch('https://localhost:5000/additem', 
      {
          method: 'POST',
    ...
    edit(updataData){
          let data ={
           ...
           console.log(data);
          //console.log(data);
          fetch('https://localhost:5000/updateitem/'+updataData.id, 
          {
              method: 'PUT',
              body: JSON.stringify(data),
              headers: { 'content-type': 'application/json' },
